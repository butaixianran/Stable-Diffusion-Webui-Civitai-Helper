...
解决方法是，让给你汉化的那个人，把这个地方给该回去。SD webui已经有汉化接口了，那么，手动修改源码的汉化，就不再是汉化人员该做的事情。如果想要这个地方支持多语言，应该是给SD webui提交issue。   

如果不想等人家给你改，你可以自己从SD Webui的源码里，把这段中文，改回`replace preview`。这段文字藏在：  
...
Civitai不像那些大网站那么稳定。他网站会挂，还会把API请求转到真人验证页面，来拒绝请求。(这个规则暂时关闭了，但他们随时能打开)    
