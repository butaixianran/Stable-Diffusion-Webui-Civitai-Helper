...
def on_ui_tabs():
    ...
    with gr.Blocks(css="button {background-color: #228be6}") as civitai_helper:
        ...
        js_save_lora_configs_btn = gr.Button(value="Save lora configs", visible=False, elem_id="ch_js_save_lora_configs_btn")
        ...
        # General
        save_setting_btn.click(setting.save_from_input, inputs=[max_size_preview_ckb, skip_nsfw_preview_ckb, open_url_with_js_ckb, always_display_ckb, show_btn_on_thumb_ckb, min_weight_js_cb, max_weight_js_cb], outputs=general_log_md)
        ...
        js_save_lora_configs_btn.click(js_action_jokker.save_lora_configs, inputs=[js_msg_txtbox], outputs=py_msg_txtbox)
